...
def main():
    r = Recruiter("Sasha", 150, 21)
    p = Programmer("Slava", 220, 23, {'have a car ', 'Python', 'JS', 'Git', 'HTML'})
    p2 = Programmer("Kostya", 200, 24, {'know of English ', 'Python', 'Django'})
    c = Candidate("Petya", "pet@com", "Razrabotka", "JS", "trenie")
    c2 = Candidate("Katya", "KET@com", "Recruter", "English", "С1")
    c3 = Candidate("Kiril", "Kir@com", "Razrabotka", "Python", "junior")
